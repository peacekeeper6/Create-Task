...
while True: 
  ...
  choice = input("\n" + "Y/N: ")
  try:
    assert choice == "y" or choice == "Y" or choice == "n" or choice == "N"
    if choice.lower() == 'y':
      prompt("Great!" + "\n")
      break
    elif choice.lower() == 'n':
...
def no_space_concise_uni(): #respective results of usernames placed in different orders due to needing to be defined before being called
  ...
  # prompt(random.choice(no_space_concise_uni))
  prompt(no_space_concise_uni[random.randint(0,200)])
  time.sleep(0.5)
...
def no_space_concise_no_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(no_space_concise_no_uni[random.randint(0,20)])
  time.sleep(0.5)
  input(prompt("\n" + "Hit enter if you want to reroll your username. Duplicates may occur."))
  os.system('clear')
...
def no_space_no_concise_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(no_space_no_concise_uni[random.randint(0,160)])
  time.sleep(0.5)
  input(prompt("\n" + "Hit enter if you want to reroll your username. Duplicates may occur."))
  os.system('clear')
...
def no_space_no_concise_no_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(no_space_no_concise[random.randint(0,20)])
  time.sleep(0.5)
  input(prompt("\n" + "Hit enter if you want to reroll your username. Duplicates may occur."))
  os.system('clear')
...
def space_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(space_uni[random.randint(0,160)])
  time.sleep(0.5)
  input(prompt("\n" + "Hit enter if you want to reroll your username. Duplicates may occur."))
  os.system('clear')
  space_uni()
...
def space_no_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(space_no_uni[random.randint(0,20)])
  time.sleep(0.5)
  input(prompt("\n" + "Hit enter if you want to reroll your username. Duplicates may occur."))
  os.system('clear')
  space_no_uni()
