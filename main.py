...
array_space_no_uni = ["Double G", "Elite Ammo", "Kill Switch", "Death Stalker", "Digital Enigma", "OG Casanova", "Tinfoil Hat", "Cough Syrup", "Night Watcher", "Undead Alive", "Worst Nightmare", "Short Fury", "Molly Wap", "Blank Space", "Bag Chaser", "The Reaper", "False Hope" "Flash Bang", "Point Blank" "Cross Hair"] #20 items
...
def no_space_concise_uni(): #respective results of usernames placed in different orders due to needing to be defined before being called
  ...
  # prompt(array_no_space_concise_uni[random.randint(0,200)])
  time.sleep(0.5)
...
def no_space_concise_no_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(array_no_space_concise_no_uni[random.randint(0,20)])
  time.sleep(0.5)
  input("\n" + "Hit enter if you want to reroll your username. Duplicates may occur.")
  os.system('clear')
...
def no_space_no_concise_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(array_no_space_no_concise_uni[random.randint(0,160)])
  time.sleep(0.5)
  input("\n" + "Hit enter if you want to reroll your username. Duplicates may occur.")
  os.system('clear')
...
def no_space_no_concise_no_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(array_no_space_no_concise[random.randint(0,20)])
  time.sleep(0.5)
  input("\n" + "Hit enter if you want to reroll your username. Duplicates may occur.")
  os.system('clear')
...
def space_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(array_space_uni[random.randint(0,160)])
  time.sleep(0.5)
  input("\n" + "Hit enter if you want to reroll your username. Duplicates may occur.")
  os.system('clear')
  space_uni()
...
def space_no_uni():
  prompt("Here is your username, thanks for playing: ")
  prompt(array_space_no_uni[random.randint(0,20)])
  time.sleep(0.5)
  input("\n" + "Hit enter if you want to reroll your username. Duplicates may occur.")
  os.system('clear')
  space_no_uni()
